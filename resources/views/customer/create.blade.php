...
@section('content')
	...
	@if ($errors->any())
		<div class="alert alert-danger">
		  <strong>ERROR!!!</strong> There are some errors in your input. <br><br>
		<ul>
	...
	<form action={{ route('customer.store') }}" method="POST">
		...
		<div class="form-group">
			...
			<textarea class="form-control" id="txtAddress" name="txtAddress" rows="10" placeholder="Enter Customer Address"></textarea>
		</div>
